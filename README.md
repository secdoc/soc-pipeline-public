...
<img width="270" height="120" alt="cerebro2_scaled" src="https://github.com/user-attachments/assets/32b79a79-ef6d-426c-9552-bdccf6a99270" />
...
### Browser View:
<img width="1896" height="1123" alt="Screenshot_2026-09-12_19-30-53" src="https://github.com/user-attachments/assets/f4a7b52e-5cd3-489c-893f-7d237821eb39" />
...
|---|---|---|
| P0, foundations and access | Required source access is substantially complete. The least-privilege DFIR API credential remains outstanding. | The sanitized [Terraform and Ansible scaffold](terraform/README.md) is published with synthetic inventory, import-first controls, and eleven gated adopter-configurable roles. Clean product convergence remains in progress. Access tracking remains [in progress](https://github.com/secdoc/soc-pipeline-public/issues/10). |
...
- [`ansible/`](ansible/README.md): eleven gated adopter-configurable roles, serial orchestration examples, defaults, candidate templates, and a baseline convergence harness. Issue 18 remains open until every product role has clean-environment two-run convergence evidence.
